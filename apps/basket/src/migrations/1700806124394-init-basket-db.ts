...
export class InitBasketDb1700806124394 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" integer NOT NULL, "title" text NOT NULL, "price" real NOT NULL, "currency" "public"."products_currency_enum" NOT NULL DEFAULT 'USD', "quantity" integer NOT NULL, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
