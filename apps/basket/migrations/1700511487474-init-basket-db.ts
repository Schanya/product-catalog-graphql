...
export class InitBasketDb1700511487474 implements MigrationInterface {
    name = 'InitBasketDb1700511487474'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" integer NOT NULL, "title" text NOT NULL, "price" real NOT NULL, "currency" text NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users_products" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "product_id" integer NOT NULL, "amount" integer NOT NULL, CONSTRAINT "PK_1fb72f1a792918a67594f65ed15" PRIMARY KEY ("id", "user_id", "product_id"))`);
